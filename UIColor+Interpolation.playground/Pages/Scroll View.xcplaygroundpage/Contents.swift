...
*/
let colors = [#colorLiteral(red: 0.3607843137254902, green: 0.02352941176470588, blue: 0.5490196078431373, alpha: 1), #colorLiteral(red: 0.9137254901960784, green: 0.2352941176470588, blue: 0.6745098039215687, alpha: 1), #colorLiteral(red: 0, green: 0.7098039215686275, blue: 0.8862745098039215, alpha: 1), #colorLiteral(red: 0.5450980392156862, green: 0.7686274509803921, blue: 0, alpha: 1), #colorLiteral(red: 1, green: 0.7215686274509804, blue: 0.1098039215686274, alpha: 1), #colorLiteral(red: 0.9372549019607843, green: 0.2, blue: 0.2509803921568627, alpha: 1)]
